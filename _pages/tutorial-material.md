...
<h4>1.1 RAG Foundations</h4>
<ul>
  <li><a href="https://proceedings.neurips.cc/paper/2020/file/6b493230205f780e1bc26945df7481e5-Paper.pdf" target="_blank">Retrieval-Augmented Generation for Knowledge-Intensive NLP Tasks.</a> (Lewis et al. NeurIPS 2020.)</li>
  <li><a href="https://aclanthology.org/2024.naacl-long.463.pdf" target="_blank">REPLUG: Retrieval-Augmented Black-Box Language Models.</a> (Shi et al. NAACL 2024.)</li>
...
<h4>1.2 Classical Relevance and Utility</h4>
<ul>
...
<h4>1.3 User-Centric Utility in Web Search</h4>
<ul>
...
<h4>1.5 Related Perspective: Denoising-First IR</h4>
<ul>
...
<ul>
  <li>Are Large Language Models Good at Utility Judgments? (TODO)</li>
  <li>An Iterative Utility Judgment Framework via LLMs Inspired by Relevance in Philosophy. (TODO)</li>
  <li>REPLUG: Retrieval-Augmented Black-Box Language Models. (Shi et al. NAACL 2024.)</li>
  <li>LLM-Specific Utility: A New Perspective for Retrieval-Augmented Generation. (TODO)</li>
  <li>SePer: Measure Retrieval Utility Through the Lens of Semantic Perplexity Reduction. (TODO)</li>
  <li>Uplift-RAG: Uplift-Driven Knowledge Preference Alignment for Retrieval-Augmented Generation. (TODO)</li>
</ul>

<h4>2.2 Task-Specific Definitions of Utility</h4>

<p><em>Factoid QA</em></p>
<ul>
  <li>Are Large Language Models Good at Utility Judgments? (TODO)</li>
  <li>Evaluating Retrieval Quality in Retrieval-Augmented Generation. (TODO)</li>
</ul>

<p><em>Non-Factoid and Complex QA</em></p>
<ul>
  <li>WebGLM: Towards an Efficient Web-Enhanced Question Answering System with Human Preferences. (TODO)</li>
  <li>DR Tulu: Reinforcement Learning with Evolving Rubrics for Deep Research. (TODO)</li>
</ul>

<p><em>Fact Verification and Classification</em></p>
<ul>
  <li>From Relevance to Utility: Evidence Retrieval with Feedback for Fact Verification. (TODO)</li>
  <li>Read It Twice: Towards Faithfully Interpretable Fact Verification by Revisiting Evidence. (TODO)</li>
</ul>

<p><em>Code Generation</em></p>
<ul>
  <li>Preference-Guided Refactored Tuning for Retrieval Augmented Code Generation. (TODO)</li>
  <li>SelfRACG: Enabling LLMs to Self-Express and Retrieve for Code Generation. (TODO)</li>
</ul>

<p><em>Tool and Skill Retrieval</em></p>
<ul>
  <li>Tool-to-Agent Retrieval: Bridging Tools and Agents for Scalable LLM Multi-Agent Systems. (TODO)</li>
  <li>SkillResolve-Bench: Measuring and Resolving Same-Capability Ambiguity in Agent Skill Retrieval. (TODO)</li>
  <li>Skill Retrieval Augmentation for Agentic AI. (TODO)</li>
  <li>Multi-Field Tool Retrieval. (TODO)</li>
</ul>

<h4>2.5 Pointwise, Marginal, and Set-Level Utility</h4>

<p><em>Pointwise Utility</em></p>
<ul>
  <li>REPLUG: Retrieval-Augmented Black-Box Language Models. (Shi et al. NAACL 2024.)</li>
  <li>Atlas: Few-shot Learning with Retrieval Augmented Language Models. (Izacard et al. JMLR 2023.)</li>
  <li>SePer: Measure Retrieval Utility Through the Lens of Semantic Perplexity Reduction. (TODO)</li>
  <li>Uplift-RAG: Uplift-Driven Knowledge Preference Alignment for Retrieval-Augmented Generation. (TODO)</li>
</ul>
...
<ul>
  <li>Modeling Contextual Passage Utility for Multihop Question Answering. (TODO)</li>
  <li>Distilling a Small Utility-Based Passage Selector to Enhance Retrieval-Augmented Generation. (TODO)</li>
  <li>Shifting from Ranking to Set Selection for Retrieval Augmented Generation. (TODO)</li>
  <li>OptiSet: Unified Optimizing Set Selection and Ranking for Retrieval-Augmented Generation. (TODO)</li>
  <li>BGM: Bridging the Preference Gap between Retrievers and LLMs. (TODO)</li>
</ul>

<h4>2.6 Evidence Format and Presentation to LLMs</h4>
<ul>
  <li>Relevance to Utility: Process-Supervised Rewrite for RAG. (TODO)</li>
  <li>ECoRAG: Evidentiality-Guided Compression for Long Context RAG. (TODO)</li>
  <li>Parametric Retrieval-Augmented Generation. (TODO)</li>
  <li>The Last Human-Written Paper: Agent-Native Research Artifacts. (TODO)</li>
  <li>Chain-of-Note: Enhancing Robustness in Retrieval-Augmented Language Models. (TODO)</li>
  <li>Injecting External Knowledge into the Reasoning Process Enhances Retrieval-Augmented Generation. (TODO)</li>
</ul>

<!-- ===== Section 3: Utility Modeling and Optimization Methods ===== -->
<h3>Section 3: Utility Modeling and Optimization Methods</h3>

<h4>3.1 Utility Signals</h4>
...
<h4>3.2 Efficiency Ladder: From Small Candidate Sets to Corpus-Scale</h4>
...
<ul>
  ...
  <li>Retrieval-Augmented Generation for Knowledge-Intensive NLP Tasks. (Lewis et al. NeurIPS 2020.)</li>
...
<h4>3.3 Evaluation: What Should We Measure?</h4>
<ul>
  <li>eRAG: Evaluating Retrieval Quality in Retrieval-Augmented Generation. (TODO)</li>
...
<h4>4.3 Document-side Utility</h4>
<ul>
